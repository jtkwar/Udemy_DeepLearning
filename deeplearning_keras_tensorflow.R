# This is the first lesson about Perceptrons
...
# here is the line of code to install the GPU version of 
# Tensorflow
...
# create the sequential neural network with keras
# 784-128-64-10 Neural Network
...
model %>% fit(part_train_images, part_train_labels, epochs = 30,
              batch_size = 100,
              validation_data=list(val_image,val_labels))
